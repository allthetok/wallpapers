  ...
  render() {
    ...
    return (
      <div className="container">
          ...
          <div className="dropdown m-2" style={{ display: "inline" }}>
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a
                ...
                href="#subChange"
                onClick={() => this.changeSubreddit(this.wallpaperSubreddits)}
              >
              ...
              <a
                className="dropdown-item"
                href="#subChange"
                onClick={() => this.changeSubreddit(this.portraitSubreddits)}
              >
                Portrait Wallpapers
              </a>
              <a
                className="dropdown-item"
                href="#subChange"
                onClick={() => this.changeSubreddit(this.memesSubreddits)}
              >
                Memes Subreddits
              </a>
        ...
        <footer>
          <center>
            <p>Some images can be explicit, please use it on your own risk.</p>
          </center>
        </footer>
      </div>
    );
